...
//Mesh one of the squares with a structured grid
Transfinite Line{7,8,9,10} = boxdim/gridsize;
Transfinite Surface{16};
Recombine Surface{16}; // regular grid (on the left)
Recombine Surface{17}; // unstructured grid (on the right)

Physical Surface(42) = {16};
Physical Surface(43) = {17};
